...
def generate_assets(temp_dir, sys, k1, k2, k3):
    """
    ...
    generate_analysis_plots(temp_dir, sys['G_cl_num'], sys['L_num'], "step.png", "nyquist.png")

    draw_main_diagram(temp_dir, "main_diag.png")
    draw_reduced_diagram(temp_dir, "reduced_diag.png")
